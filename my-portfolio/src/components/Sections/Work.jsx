...
function Work() {
  return (
    <>
      <section id="work" className="work mt-20">
        <h1 className="max-phone:text-3xl text-5xl">My Work</h1>
        <div className="my-12 h-auto" id="card">
          <div className="intro">
            <div className="flex justify-between">
              <p className="title max-phone:text-2xl text-4xl">AllerGenius</p>
              <div className="flex w-1/6 max-phone:w-1/4 max-pc:w-1/3 justify-evenly">
                <svg
                  className="githubIcon max-phone:h-6  h-12 w-12 mt-8"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 48 48"
                >
                  <a href="https://www.behance.net/gallery/189129547/Allergenius">
                    <path fill="currentColor" d="M24 43L16 20 32 20z"></path>
                    <path fill="currentColor" d="M24 43L42 20 32 20z"></path>
                    <path fill="currentColor" d="M37 5L42 20 32 20z"></path>
                    <path fill="currentColor" d="M24 43L42 20 45 28z"></path>
                    <path fill="currentColor" d="M24 43L6 20 16 20z"></path>
                    <path fill="currentColor" d="M11 5L6 20 16 20z"></path>
                    <path fill="currentColor" d="M24 43L6 20 3 28z"></path>
                  </a>
                </svg>
                <svg
                  className="githubIcon max-phone:h-6  h-12 w-12 mt-8"
            ...
            <p className="max-phone:text-base text-xl opacity-50 subtitle">
        ...
        <div className="my-12 h-auto" id="card">
          <div className="intro">
            <div className="flex justify-between">
              <p className="title max-phone:text-2xl text-4xl">InnerPeace</p>
              <div className="flex w-1/6 max-phone:w-1/4 max-pc:w-1/3 justify-evenly">
                <svg
                  className="githubIcon max-phone:h-6  h-12 w-12 mt-8"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="max-phone:text-base text-xl opacity-50 subtitle">
              A platform designed to guide you through the process of personal
              growth, step by step.
            </p>
          </div>
          <div className="flex flex-wrap justify-center ">
            <div className="pc:w-1/5 flex max-phone:w-full justify-center tablet:m-auto">
              <img
                className="h-36"
            ...
            <div className="max-phone:text-sm text-xl leading-snug text-sm flex-wrap tablet:w-full pc:w-4/6 max-pc:mb-12 mx-12 pc:m-12  ">
              <p>
                InnerPeace is an innovative platform designed to promote mental
                well-being and habit improvement. Developed in collaboration
                with a friend, this application helps users focus on their
                personal goals by providing specific activities to support them
                along the way. Additionally, it features tools to track
                progress, such as a journal for monitoring thought evolution,
                and a community section that fosters interaction among members.
                Built with Vue on the frontend and a REST API with MySQL on the
                backend, InnerPeace combines efficient technology with a
                meaningful purpose.
              </p>
            </div>
          </div>
